          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div style="text-align:center" class="card-body">
                           @foreach($abouts as $about)                                <a href="{{ url('/t@k3m3t0@dm!n/about/'.$about->id.'/edit') }}" class="btn btn-primary">Edit About</a>
                            <br>
                            <br>
                            <img style="width:80%;" class="img-fluid" src="{{ asset($about->image) }}" alt="Post header image">
                            <br>
                            <br>
                            <p>{!! $about->body!!}</p>
                            <br>
            ...
            <div class="card-body">
                    <div style="text-align:center" class="card-body">
                            <a href="{{ url('/t@k3m3t0@dm!n/gallery/create') }}" class="btn btn-primary">Post new picture</a>
                                    ...
                                    <br>
                                    <img style="width:80%;" class="img-fluid" src="{{ asset($picture->image) }}" alt="Post header image">
                                    <br><br>
                    ...
                    <div style="text-align:center" class="card-body">
                            <a href="{{ url('/t@k3m3t0@dm!n/blog/create') }}" class="btn btn-primary">Create new post</a>
                                    @foreach($posts as $post)
                                            ...
                                            <br>
                                            <img style="width:80%;" class="img-fluid" src="{{ asset($post->image) }}" alt="Post header image">
                                            <h1>{!! $post->title !!}</h1>
                                            <br>
